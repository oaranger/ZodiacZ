        ...
        didSet {
            let descriptionLabel: UILabel = {
                ...
                if let today = forecastData["today"], let date = today.date, let horoscope = today.horoscope {
                    attributedText.append(NSAttributedString(string: "Today (\(date))", attributes: [.foregroundColor: UIColor.black, .font: UIFont.boldSystemFont(ofSize: 20)]))
                    attributedText.append(NSAttributedString(string: "\n\n"))
                    attributedText.append(NSAttributedString(string: horoscope, attributes: [.foregroundColor: UIColor.gray]))
                    attributedText.append(NSAttributedString(string: "\n\n"))
                }
                
                if let week = forecastData["week"], let date = week.week, let horoscope = week.horoscope {
                    attributedText.append(NSAttributedString(string: "This Week", attributes: [.foregroundColor: UIColor.black, .font: UIFont.boldSystemFont(ofSize: 20)]))
                    attributedText.append(NSAttributedString(string: "\n\n"))
                    attributedText.append(NSAttributedString(string: horoscope, attributes: [.foregroundColor: UIColor.gray]))
                    attributedText.append(NSAttributedString(string: "\n\n"))
                }
                ...
                if let month = forecastData["month"], let date = month.month, let horoscope = month.horoscope {
                    attributedText.append(NSAttributedString(string: "This Month (\(date))", attributes: [.foregroundColor: UIColor.black, .font: UIFont.boldSystemFont(ofSize: 20)]))
                    attributedText.append(NSAttributedString(string: "\n\n"))
                    attributedText.append(NSAttributedString(string: horoscope, attributes: [.foregroundColor: UIColor.gray]))
                    attributedText.append(NSAttributedString(string: "\n\n"))
                }
                ...
                if let year = forecastData["year"], let date = year.year, let horoscope = year.horoscope {
                    attributedText.append(NSAttributedString(string: "This Year (\(date))", attributes: [.foregroundColor: UIColor.black, .font: UIFont.boldSystemFont(ofSize: 20)]))
                    attributedText.append(NSAttributedString(string: "\n\n"))
                    attributedText.append(NSAttributedString(string: horoscope, attributes: [.foregroundColor: UIColor.gray]))
                }                
